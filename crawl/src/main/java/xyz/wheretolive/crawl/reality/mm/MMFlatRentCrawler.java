...
public class MMFlatRentCrawler extends MMCrawler {

    private static final String MM_FLATS_RENT_URL = "https://www.mmreality.cz/nemovitosti/pronajem/byty/";

    @Override
    public Collection<MapObject> crawl() {
        int pagesCount = getPageCount(MM_FLATS_RENT_URL);
        Set<String> urls = getItemUrls(MM_FLATS_RENT_URL, pagesCount);
