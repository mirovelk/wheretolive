...
public class MMHouseRentCrawler extends MMCrawler {

    private static final String MM_HOUSES_RENT_URL = "https://www.mmreality.cz/nemovitosti/pronajem/domy/";

    @Override
    public Collection<MapObject> crawl() {
        int pagesCount = getPageCount(MM_HOUSES_RENT_URL);
        Set<String> urls = getItemUrls(MM_HOUSES_RENT_URL, pagesCount);
